exports.seed = async (knex) => {
   await knex("steps").insert([
      ...
      {step_number: 4, instructions: "Add mushrooms and heat through", recipe_id: 1},
      {step_number: 5, instructions: "Combine all ingredients into one pot. Then, add the tomato juice.", recipe_id: 1},
